...
const items = [
    ...
    // --- ITEM 19: CUT THE ROPE ---
    {
        ...
        description: `Om Nom's sweetest adventure is here! Play puzzling mini-games with Om Nom in this Cut the Rope adventure. Unlock, mix and match 50+ Om Nom costumes.
...
+ Complex boss fight mechanism!`,
    ...
    // --- ITEM 17: WITHER APOCALYPSE ---
    {
        ...
        description: `What happened to the Wither? IT’S OP! Can you survive its dangerous powers?
...
+ Decorative and functional Furniture`,
    ...
    // --- ITEM 15: TRUE REALISM HD ---
    {
        ...
        description: `Redefine your world with next-level HD graphics and stunning visual features.
...
function displayItems(data) {
    ...
    data.forEach(item => {
        ...
        // Smart Thumbnail: Images array ka pehla item, ya 'image' property
...
// --- 5. MODAL LOGIC (UPDATED: Horizontal Buttons & Panorama) ---
...
function openModal(item) {
    ...
    if (item.links && item.links.length > 0) {
        item.links.forEach(link => {
            ...
            a.href = link.url;
            a.target = "_blank";
            // Horizontal Design: Only Icon + Text
            a.innerHTML = `<i class="fas ${link.icon || 'fa-download'}"></i> ${link.type}`;
